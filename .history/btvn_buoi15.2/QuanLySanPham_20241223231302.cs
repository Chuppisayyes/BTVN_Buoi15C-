    ...
    public void DocDuLieuTuFile()
    {
        if (File.Exists(filePath))
        {
            try
            {
                ...
                // Deserializing JSON thành List<SanPham>
                ...
                if (tempList != null)
                {
                    ...
                    {
                        // Kiểm tra nếu LoaiSanPham có giá trị hợp lệ
                        if (item != null && !string.IsNullOrEmpty(item.LoaiSanPham))
                        {
                            if (item.LoaiSanPham == "DienTu")
                            {
                                // Deserializing thành đối tượng DienTu
                            ...
                            {
                                // Deserializing thành đối tượng ThoiTrang
                            ...
                            {
                                // Deserializing thành đối tượng ThucPham
